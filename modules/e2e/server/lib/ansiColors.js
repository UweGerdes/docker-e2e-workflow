...
function replaceAnsiColors (string) {
  ...
  string.toString().split(/(\u001B\[[0-9;]+m)/) // eslint-disable-line no-control-regex
    .forEach(function (part) {
      if (part.match(/(\u001B\[[0-9;]+m)/)) { // eslint-disable-line no-control-regex
        part = part.replace(/\u001B\[([0-9;]+)m/, '$1'); // eslint-disable-line no-control-regex
